        ...
        if "buttons" in self.narrative[self.scene_number]:
            ...
            if "beginning_playback" in self.narrative[self.scene_number]:
                ...
                for i, button in enumerate(self.buttons):
                    button.set_text(self.readback[i][0])
                    button.set_sound_narration(self.readback[i][1])
                    button.set_hover_sound(self.readback[i][2])
                    button.set_sound_selected(self.readback[i][3])
            else:
